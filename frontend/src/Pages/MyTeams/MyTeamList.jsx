...
const MyTeamList = () => {
  ...
  return (
    ...
    className="px-3 shadow-sm rounded-2 d-flex flex-column gap-2 justify-content-between pb-3 pt-2">
      ...
      <CustomModal show={showModal} onClose={handleCloseModal} title={`${selectedDepartment}`}>
          ...
          <div className="m-0 d-flex flex-column gap-2">
            {teamData[selectedDepartment].map((member, idx) => (
              ...
              >
                ...
                <Button
                  className="btn py-0 text-white shadow-sm px-2 border rounded-5 text-decoration-none"
                  variant="link"
...
export const CustomModal = ({ show, onClose, title, children }) => {
  ...
  return (
    <div onClick={onClose} className="custom-modal-overlay">
      <div onClick={handleModalClick} className="custom-modal">
